...
import com.curso.AvanceProyectoIntegrador.service.UploadFileService;
...
public class ProductoController {
	...
	public String update(Producto producto, @RequestParam("img") MultipartFile file) throws IOException {
		...
		if (file.isEmpty()) { // editamos el producto pero no la imagen
			...
			producto.setImagen(p.getImagen());
		} else { // cuando se edita junto con la imagen

			if (!p.getImagen().equals("default.jpg")) { // eliminar si no es la imagen por defecto
	...
	public String delete(@PathVariable Integer id) {
		...
		if (!p.getImagen().equals("defautl.jpg")) { // eliminar si no es la imagen por defecto
			upload.deleteImage(p.getImagen());
		}
